...
\begin{document}
	...
	\begin{frame}
		...
		\begin{itemize}
			\item Cada ficha preenchida torna-se uma \textit{linha} ou \textit{registro} na tabela
			
			\item Os campos do formulário tornam-se colunas na tabela
		\end{itemize}		
	\end{frame}
	...
	\begin{frame}
		...
		Para criar uma tabela como essa, utilizamos o seguinte código SQL:
		\vspace{7mm}
	...
	\begin{frame}
		...
		Para criar uma tabela, utilizamos o comando \textbf{\texttt{CREATE TABLE}}:
		\vspace{3mm}
		\lstinputlisting[language=Sql]{table-consultas-ingest-1.sql}
	\end{frame}
	
	\begin{frame}
		\frametitle{Consultar registros}
		Para consultar os registros de uma tabela, usamos o comando \textbf{\texttt{SELECT}}.
	...
	\begin{frame}
		...
		Para atualizar os registros de uma tabela, usamos o comando \textbf{\texttt{UPDATE...SET}} 
